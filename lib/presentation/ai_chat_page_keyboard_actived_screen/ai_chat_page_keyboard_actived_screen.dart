...
import 'controller/ai_chat_page_keyboard_actived_controller.dart';

// ignore_for_file: must_be_immutable
class AiChatPageKeyboardActivedScreen
    extends GetWidget<AiChatPageKeyboardActivedController> {
  const AiChatPageKeyboardActivedScreen({Key? key})
      : super(
          key: key,
        );
