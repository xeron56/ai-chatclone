...
import 'controller/ai_chat_page_screen_start_details_controller.dart';

// ignore_for_file: must_be_immutable
class AiChatPageScreenStartDetailsScreen
    extends GetWidget<AiChatPageScreenStartDetailsController> {
  const AiChatPageScreenStartDetailsScreen({Key? key})
      : super(
          key: key,
        );
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomIconButton(
              ...
              child: CustomImageView(
                imagePath: ImageConstant.imgFluentMic16Filled,
              ),
            ),
          ),
        ],
