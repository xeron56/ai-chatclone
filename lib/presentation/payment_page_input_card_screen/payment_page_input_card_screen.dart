...
import 'controller/payment_page_input_card_controller.dart';

// ignore_for_file: must_be_immutable
class PaymentPageInputCardScreen
    extends GetWidget<PaymentPageInputCardController> {
  PaymentPageInputCardScreen({Key? key})
      : super(
          key: key,
        );
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomDropDown(
                            icon: Container(
                              margin:
                                  EdgeInsets.fromLTRB(30.h, 24.v, 20.h, 24.v),
                            ...
                            hintText: "lbl_your_contry".tr,
                            items: controller.paymentPageInputCardModelObj.value
  ...
  Widget _buildZero() {
    return CustomElevatedButton(
      height: 50.v,
      text: "msg_0000_0000_0000_0000".tr,
  ...
  Widget _buildNext() {
    return CustomElevatedButton(
      text: "lbl_next".tr,
      buttonStyle: CustomButtonStyles.fillBlueGrayTL32,
