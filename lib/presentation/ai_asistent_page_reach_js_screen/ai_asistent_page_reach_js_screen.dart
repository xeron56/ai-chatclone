...
import 'controller/ai_asistent_page_reach_js_controller.dart';

// ignore_for_file: must_be_immutable
class AiAsistentPageReachJsScreen
    extends GetWidget<AiAsistentPageReachJsController> {
  const AiAsistentPageReachJsScreen({Key? key})
      : super(
          key: key,
        );
