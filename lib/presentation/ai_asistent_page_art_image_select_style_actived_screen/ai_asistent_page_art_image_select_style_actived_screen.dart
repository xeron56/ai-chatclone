...
import '../ai_asistent_page_art_image_select_style_actived_screen/widgets/frame_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:ai_chatclone/core/app_export.dart';
import 'controller/ai_asistent_page_art_image_select_style_actived_controller.dart';

// ignore_for_file: must_be_immutable
class AiAsistentPageArtImageSelectStyleActivedScreen
    extends GetWidget<AiAsistentPageArtImageSelectStyleActivedController> {
  const AiAsistentPageArtImageSelectStyleActivedScreen({Key? key})
      : super(
          key: key,
        );
    ...
    return Obx(
      () => Wrap(
        ...
        children: List<Widget>.generate(
          controller.aiAsistentPageArtImageSelectStyleActivedModelObj.value
  ...
  Widget _buildFrame3() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(bottom: 162.v),
            child: CustomIconButton(
              height: 56.adaptSize,
              width: 56.adaptSize,
              padding: EdgeInsets.all(16.h),
