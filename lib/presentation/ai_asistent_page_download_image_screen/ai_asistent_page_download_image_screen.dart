...
import 'controller/ai_asistent_page_download_image_controller.dart';

// ignore_for_file: must_be_immutable
class AiAsistentPageDownloadImageScreen
    extends GetWidget<AiAsistentPageDownloadImageController> {
  const AiAsistentPageDownloadImageScreen({Key? key})
      : super(
          key: key,
        );
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration:
                              AppDecoration.outlineBluegray80054.copyWith(
                            borderRadius: BorderRadiusStyle.roundedBorder20,
                          ),
                          child: Text(
                            "lbl_art".tr,
                        ...
                        children: [
                          CustomIconButton(
                            ...
                            child: CustomImageView(
                              imagePath: ImageConstant.imgIonShare,
                            ),
                          ),
                          Padding(
